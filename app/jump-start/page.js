        ...
        <section className="mt-8 rounded-2xl bg-white p-6 shadow-sm ring-1 ring-gray-200">
          <div className="mb-5">
            ...
            <p className="mt-3 max-w-3xl text-gray-700">
              A training video can be added here later to demonstrate safe
              battery inspection, proper connection order, jump pack use,
              polarity verification, and customer communication.
            </p>
          </div>
          ...
          <div className="overflow-hidden rounded-xl border border-gray-300 bg-gray-200">
            <div className="aspect-video">
              <iframe
                ...
                title="Jump Start Training Video"
          ...
          <div className="mt-4 rounded-xl bg-gray-50 p-4 text-sm text-gray-700 ring-1 ring-gray-200">
            ...
            <p className="mt-1">
              ...
              YouTube video ID for the jump start training video you want to use.
            </p>
          </div>
        </section>
